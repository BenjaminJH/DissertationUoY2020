...
public class pNSGAII extends Algorithm {
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    while (evaluations < maxEvaluations) {
      ...
      union = ((SolutionSet) population).union(offspringPopulation); //This will be greater than our POPULATION_SIZE

      // Ranking the union
      Ranking ranking = new Ranking(union); 	//This is where it is ordered by best results to worst
