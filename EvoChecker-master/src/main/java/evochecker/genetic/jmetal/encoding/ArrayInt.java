...
public class ArrayInt extends Variable {
	...
	public int[] getArray() { //New for OMOPSO testing
		return array_;
	} //getArray
	
	public void setArray(int[] myarray) { //New for OMOPSO testing
		this.array_ = myarray;
		this.size_ = myarray.length;
	}
	
	public int[] getUpperBoundArray() { //New for OMOPSO testing
		return upperBounds_;
	} //getUpperBoundArray
	
	public int[] getLowerBoundArray() { //New for OMOPSO testing
		return lowerBounds_;
	} //getLowerBoundArray
	
	public void setUpperBoundArray(int[] array) { //New for OMOPSO testing
		upperBounds_ = array;
	} //setUpperBoundArray
	
	public void setLowerBoundArray(int[] array) { //New for OMOPSO testing
		lowerBounds_ = array;
	} //setLowerBoundArray
