...
public class XReal {
	...
	public double getValue(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class) ||
			...
			System.out.println("type_.getClass() == (RealSolutionType.class || BinaryRealSolutionType.class) in XREAL getvalue");
			return solution_.getDecisionVariables()[index].getValue() ;			
		} 
		else if (type_.getClass() == ArrayRealSolutionType.class) {
			System.out.println("type_.getClass() == ArrayRealSolutionType.class in XREAL getvalue");
			...
			System.out.println("type_.getClass() == ArrayRealAndBinarySolutionType.class in XREAL getvalue");
			return ((ArrayReal)(solution_.getDecisionVariables()[0])).array_[index] ;
		}
		else if (type_.getClass() == ArrayRealIntSolutionType.class) {
//			System.out.println("Correct Typing in XREAL getvalue");
			return ((ArrayReal)(solution_.getDecisionVariables()[0])).array_[index] ;
		}
		else {
			System.out.println("For some reason the type is..." + type_.getClass());
	...
	public void setValue(int index, double value) throws JMException {
		if (type_.getClass() == RealSolutionType.class) {
			System.out.println("incorrect typing in XREAL SetValue");
...
//			System.out.println("Correct typing in XREAL SetValue");
			((ArrayReal)(solution_.getDecisionVariables()[0])).array_[index]=value ;}
		else {
			System.out.println("incorrect typing in XREAL SetValue");
