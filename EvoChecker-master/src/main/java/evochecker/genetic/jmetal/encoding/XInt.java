  ...
  private XInt() {
	...
	public int getValue(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class){
			System.out.println("incorrect typing in XInt GetValue");
...
//			System.out.println("Correct Typing in XInt getvalue");
	...
	public void setValue(int index, int value) throws JMException {
		if (type_.getClass() == IntSolutionType.class) {
			System.out.println("incorrect typing in XInt SetValue");
