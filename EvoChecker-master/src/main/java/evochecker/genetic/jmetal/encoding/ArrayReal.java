...
public class ArrayReal extends Variable {
	...
	public Double[] getArray() { //New for OMOPSO testing
		return array_;
	} //getArray
	
	public void setArray(Double[] myarray) { //New for OMOPSO testing
		this.array_ = myarray;
		this.size_ = myarray.length;
	}
	
	public double[] getUpperBoundArray() { //New for OMOPSO testing
		return upperBounds_;
	} //getUpperBoundArray
	
	public double[] getLowerBoundArray() { //New for OMOPSO testing
		return lowerBounds_;
	} //getLowerBoundArray
	
	public void setUpperBoundArray(double[] array) { //New for OMOPSO testing
		upperBounds_ = array;
	} //setUpperBoundArray
	
	public void setLowerBoundArray(double[] array) { //New for OMOPSO testing
		lowerBounds_ = array;
	} //setLowerBoundArray
