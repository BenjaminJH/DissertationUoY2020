...
evolve const int N[8..8]; // number of pairs of secrets the party sends
evolve const int L[2..2]; // number of bits in each secret

evolve module counter
...
evolve module partyB=partyA[b0 =a0 ,b1 =a1 ,b2 =a2 ,b3 =a3 ,b4 =a4 ,b5 =a5 ,b6 =a6 ,b7 =a7 ,b8 =a8 ,b9 =a9,
